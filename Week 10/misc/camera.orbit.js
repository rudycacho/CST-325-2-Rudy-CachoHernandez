function OrbitCamera (input) {
	...
	this.getPosition = function() {
		...
		return new Vector3(this.cameraWorldMatrix.getElement(1,3),this.cameraWorldMatrix.getElement(2,3),this.cameraWorldMatrix.getElement(3,3)/*,this.cameraWorldMatrix.getElement(4,3)*/);
	}
