function OrbitCamera (input) {
	...
	this.getPosition = function() {
		//return a vector4 of the camera's world position contained in its matrix
		return new Vector4(this.cameraWorldMatrix.getElement(1,3),this.cameraWorldMatrix.getElement(2,3),this.cameraWorldMatrix.getElement(3,3),this.cameraWorldMatrix.getElement(4,3));
	}
